...
(
	...
	Confectionary_Type_Name	varchar(),
	Confectionary_Type_Desc	verchar()
);
...
(
	...
	Movie_ID	int	FOREIGN KEY REFRENECES Movie_Info(Movie_ID),
	Ticket_Total	double
);
...
(
	...
	CONSTRAINT CP_Actor_On-Movie PRIMARY KEY (Actor_ID,Movie_ID),
